...
function LoginPage() {
    ...
    const handleLogin = async (event)=>{
        ...
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])('/auth/demo-login', {
                method: 'POST',
                body: {
                    email,
                    name
    ...
    const handleOAuth = async (provider)=>{
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/auth/${provider}/url`);
...
_s(LoginPage, "lmwvelPX53xGvI1qOVxlpoJ6Q3I=", false, function() {
    return [
...
//# sourceMappingURL=_b85034e8._.js.map